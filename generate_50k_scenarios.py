...
║                                                                      ║
║  Usage :                                                             ║
║    python3 generate_50k_scenarios.py --run                           ║
║    python3 generate_50k_scenarios.py --status                        ║
║                                                                      ║
...
def generate_one(industry_key, industry, brand, product, idx, is_personnage, progress):
    ...
    try:
        ...
        return f"ERROR:{custom_id}:{str(e)}"
...
if __name__ == "__main__":
    ...
    if args.run:
        ...
        parser.print_help()
        print("\n💡 Lancez : python3 generate_50k_scenarios.py --run")